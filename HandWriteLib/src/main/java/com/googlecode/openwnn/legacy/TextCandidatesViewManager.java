...
import com.jyn.handwriterecogize.R;
...
public class TextCandidatesViewManager implements CandidatesViewManager, GestureDetector.OnGestureListener {
	...
	public View initView(OpenWnn parent, int width, int height) {
		...
		mReadMoreButton.setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
		...
		mReadMoreButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (!v.isShown()) {
					return;
				}
	...
	/** @see GestureDetector.OnGestureListener#onFling */
	...
	/** @see GestureDetector.OnGestureListener#onScroll */
	public boolean onScroll(MotionEvent arg0, MotionEvent arg1, float arg2, float arg3) {
		return false;
	}

	/** @see GestureDetector.OnGestureListener#onShowPress */
